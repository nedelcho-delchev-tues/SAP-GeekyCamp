...
public class FacultyDAO {
	...
	public void createNewFaculty(int facultyId, String FacultyName, String FacultyDescription, 
			List<Student>  students) {
		Faculty newFaculty = new Faculty(facultyId, FacultyName, FacultyDescription, students);
		EntityManager em = null;
		EntityTransaction tx = null;
		try {
			em = emf.createEntityManager();
	...
	private void updateProps(Faculty willBeUpdated, Faculty updateInfo) {
		...
		willBeUpdated.setFacultyDescription(updateInfo.getFacultyDescription());
	}
